...
namespace FastMapper.NetCore.Utils
{
    public sealed class PropertyCaller<T, K> where T : class
    {
        ...
        private static readonly Dictionary<Type, Dictionary<Type, Dictionary<string, GenGetter>>> dGets =
            new Dictionary<Type, Dictionary<Type, Dictionary<string, GenGetter>>>();

        private static readonly Dictionary<Type, Dictionary<Type, Dictionary<string, GenSetter>>> dSets =
    ...
    public static class PropertyCaller<T>
    {
        ...
        public static GenGetter CreateGetMethod(PropertyInfo pi)
        {
            ...
            if (dGets.TryGetValue(classType, out i1))
            {
                ...
                {
                    GenGetter i3 = null;
                    if (i2.TryGetValue(propName, out i3)) return i3;
                }
            }
            ...
            var getter = new DynamicMethod(string.Concat("_Get", pi.Name, "_"), typeof(object), new[] {typeof(T)},
                classType);
        ...
        public static GenSetter CreateSetMethod(PropertyInfo pi)
        {
            ...
            //Create dynamic method
            var arguments = new Type[2] {classType, typeof(object)};
