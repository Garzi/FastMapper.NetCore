    ...
    public class TypeAdapterConfig<TSource, TDestination>
    {
            ...
            params Expression<Func<TDestination, object>>[] members)
        {
            ...
            if (members != null && members.Length > 0)
            {
                ...
                for (var i = 0; i < members.Length; i++)
                {
                    ...
                    if (memberExp != null) config.IgnoreMembers.Add(memberExp.Member.Name);
                }
            }
        ...
        public TypeAdapterConfig<TSource, TDestination> IgnoreMember(params string[] members)
        {
            ...
            if (members != null && members.Length > 0)
            {
                ...
                {
                    var config = Configuration;
                    for (var i = 0; i < members.Length; i++) config.IgnoreMembers.Add(members[i]);
                }
            }
        ...
        public TypeAdapterConfig<TSource, TDestination> MapFrom<TKey>(Expression<Func<TDestination, TKey>> member,
            Expression<Func<TSource, TKey>> sourceExpression)
        {
            _Projection.MapFrom(member, sourceExpression);
            ...
            if (func != null)
            {
                ...
                if (memberExp != null)
                    config.Resolvers.Add(new InvokerModel<TSource>
                    {
